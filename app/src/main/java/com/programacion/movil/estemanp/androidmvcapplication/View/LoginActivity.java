...
import com.programacion.movil.estemanp.androidmvcapplication.Controller.SingletonController;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login(View view) {
        if(SingletonController.get_instance().isValidUser(userName.getText().toString(),password.getText().toString())) {
